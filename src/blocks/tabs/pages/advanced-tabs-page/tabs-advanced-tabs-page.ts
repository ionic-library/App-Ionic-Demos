...
@Component({
  templateUrl: 'tabs-advanced-tabs-page.html'
})
export class TabsAdvancedTabsPage {
  ...
  ionViewWillEnter() {
    console.log('TabsAdvancedTabsPage, ionViewWillEnter');
  }

  ionViewDidEnter() {
    console.log('TabsAdvancedTabsPage, ionViewDidEnter');
  }

  ionViewWillLeave() {
    console.log('TabsAdvancedTabsPage, ionViewWillLeave');
  }

  ionViewDidLeave() {
    console.log('TabsAdvancedTabsPage, ionViewDidLeave');
  }

  ionViewWillUnload() {
    console.log('TabsAdvancedTabsPage, ionViewWillUnload');
  }
}

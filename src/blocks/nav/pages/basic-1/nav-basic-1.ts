...
export class NavBasic1 {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad, NavBasic1', this.viewCtrl.id);
  }

  ionViewWillEnter() {
    console.log('ionViewWillEnter, NavBasic1', this.viewCtrl.id);
  }

  ionViewDidEnter() {
    console.log('ionViewDidEnter, NavBasic1', this.viewCtrl.id);
  }

  ionViewWillLeave() {
    console.log('ionViewWillLeave, NavBasic1', this.viewCtrl.id);
  }

  ionViewDidLeave() {
    console.log('ionViewDidLeave, NavBasic1', this.viewCtrl.id);
  }

  ionViewWillUnload() {
    console.log('ionViewWillUnload, NavBasic1', this.viewCtrl.id);
  }

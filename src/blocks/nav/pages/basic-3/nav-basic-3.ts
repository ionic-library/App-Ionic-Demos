...
export class NavBasic3 {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad, NavBasic3', this.viewCtrl.id);
  }

  ionViewWillEnter() {
    console.log('ionViewWillEnter, NavBasic3', this.viewCtrl.id);
  }

  ionViewDidEnter() {
    console.log('ionViewDidEnter, NavBasic3', this.viewCtrl.id);
  }

  ionViewWillLeave() {
    console.log('ionViewWillLeave, NavBasic3', this.viewCtrl.id);
  }

  ionViewDidLeave() {
    console.log('ionViewDidLeave, NavBasic3', this.viewCtrl.id);
  }

  ionViewWillUnload() {
    console.log('ionViewWillUnload, NavBasic3', this.viewCtrl.id);
  }

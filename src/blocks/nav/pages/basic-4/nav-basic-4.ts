...
export class NavBasic4 {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad, NavBasic4', this.viewCtrl.id);
  }

  ionViewWillEnter() {
    console.log('ionViewWillEnter, NavBasic4', this.viewCtrl.id);
    this.viewCtrl.setBackButtonText('Previous');
    this.subheader = 'I\'m a sub header!';
  }

  ionViewDidEnter() {
    console.log('ionViewDidEnter, NavBasic4', this.viewCtrl.id);
  }

  ionViewWillLeave() {
    console.log('ionViewWillLeave, NavBasic4', this.viewCtrl.id);
  }

  ionViewDidLeave() {
    console.log('ionViewDidLeave, NavBasic4', this.viewCtrl.id);
  }

  ionViewWillUnload() {
    console.log('ionViewWillUnload, NavBasic4', this.viewCtrl.id);
  }
